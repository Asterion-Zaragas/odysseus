...
Generate an image. Line 1 = description, line 2 = model name, line 3 = WxH (e.g. 1024x1024), line 4 = quality.""",
    ...
    "retrieve_memory_context": "- ```retrieve_memory_context``` — Re-search the user's saved memories mid-task at a chosen depth, independent of whatever memory context was already auto-injected this turn. Line 1 = query, optional line 2 = effort (low/medium/high, default medium — higher effort searches more of the store and verifies relevance at the cost of latency). Use when you need to look up something from memory that isn't already in context — NOT for saving new facts (use manage_memory for that).",
